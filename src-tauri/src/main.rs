...
use commands::{
    ...
    embedding_info, embedding_delete, embedding_rebuild_all, embedding_server_status, export_dataset, greet, image_confirm_import, image_discard_staged, image_edit,
